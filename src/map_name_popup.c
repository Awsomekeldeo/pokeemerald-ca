...
static const u8 sMapPopUp_Table[][960] =
{
    ...
    //[MAPPOPUP_THEME_SNOW]       = INCBIN_U8("graphics/map_popup/snow.4bpp")
};
...
static const u8 sMapPopUp_OutlineTable[][960] =
{
    ...
    //[MAPPOPUP_THEME_SNOW]       = INCBIN_U8("graphics/map_popup/snow_outline.4bpp")
};
...
static const u16 sMapPopUp_PaletteTable[][16] =
{
    ...
    //[MAPPOPUP_THEME_SNOW]       = INCBIN_U16("graphics/map_popup/snow.gbapal")
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_MT_RECOUP] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_SERENITY_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VERDURE_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ATRAMEN_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PALISADE_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CHALET_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MONOLITH_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_FRACCA_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_LAZIMAR_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ROUTE_13 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ROUTE_14 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_15 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_16 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_17 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_18 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_19 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_20 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_21 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_22 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_URSIRE_CHAMBER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_HALFWIND_ISLAND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TEMPEST_STATION - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SEQUESTERED_ISLE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CHALET_LIGHTHOUSE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
};
